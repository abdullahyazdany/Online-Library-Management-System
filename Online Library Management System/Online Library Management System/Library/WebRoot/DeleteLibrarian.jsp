...
<div id="sidebar">
		<div id="news" class="boxed1">
			<blockquote>
			  <blockquote>
			    <h2 class="title">Delete Librarian</h2>
		      </blockquote>
		  </blockquote>
	  </div>
   <FORM action="DeleteLibrarian" name="deletelibrarian" method="post">
 <table width="255" height="74" align="center">
   <tr>
     ...
     %><td width="76"><span class="style1">Librarian ID</span></td>
<TD width="142"><select name="libid">
     ...
     <tr></tr>
     <tr>
     <td align="center" colspan="2"><br><input type="submit" value="Delete Librarian"/></td>
     </tr>
     </table>
</FORM>
  </div>
