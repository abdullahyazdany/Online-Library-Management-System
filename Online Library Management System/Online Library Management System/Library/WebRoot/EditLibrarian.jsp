...
<div id="sidebar">
		<div id="news" class="boxed1">
			<blockquote>
			  <blockquote>
			    <h2 class="title">Modify Librarian</h2>
		      </blockquote>
		  </blockquote>
	  </div>
   <FORM action="EditLibrarian.jsp" name="getbook" method="post">
   ...
   <tr>
     <%
        ...
        try
		{
            ...
            ResultSet rs=st.executeQuery("select reg_id from lms_libregistration");
            %><td width="88"><span class="style1">Librarian ID</span></td>
     <TD width="89"><select name="libid">
...
<br><FORM action="ModifyLibrarian" name="modifylibrarian" method="post" onSubmit="return fun()">
<%
      if(request.getParameter("libid")!=null)
      {
        rs=st.executeQuery("select * from lms_libregistration where reg_id='"+request.getParameter("libid")+"'");
        if(rs.next())
        {
%>
 ...
 <tr>
     <td width="107"><span class="style1">Librarian ID</span></td>
     <TD width="159"><input type="text" name="libid" value=<%=rs.getString(1)%> readonly/></TD>
     </tr>
     <tr>
